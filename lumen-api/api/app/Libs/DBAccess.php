...
class DBAccess
{
     ...
     * @return array
     */
    public function getChunkParams($binds, $maxParams = Common::MAX_INSERT_VALUES)
    {

        $chunkParams = array();

        foreach (array_chunk($binds, $maxParams > Common::MAX_INSERT_VALUES ? Common::MAX_INSERT_VALUES : $maxParams) as $chunkBinds) {
